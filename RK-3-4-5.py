...
for j in range(3):
    ...
    panda_data.columns=["y_true","RK-3","RK-3 Error(%)","RK-4","RK-4 Error(%)","RK-5","RK-5 Error(%)"]
    ...
    plt.plot(x_val,c_data[1],'g--',label="RK-3 Method",marker='o')
    plt.plot(x_val,c_data[3],'r--',label="RK-4 Method",marker='o')
    plt.plot(x_val,c_data[5],'y--',label="RK-5 Method",marker='o')
